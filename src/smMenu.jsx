...
export function MenuSM({ activeElement }) {
    return(
        <>
            <nav className="conatiner-md navbar navbar-light fixed-bottom" id='menusm'>
                    <ul className="nav nav-pills d-flex justify-content-evenly pt-2 pb-1">
                        ...
                        <li className="nav-item">
                            <a className={activeElement === 'profile' ? "nav-link active d-flex align-items-center" : "nav-link d-flex align-items-center" } href='/profile'>
                                <img src={profilepic} width={24} height={20}  />
